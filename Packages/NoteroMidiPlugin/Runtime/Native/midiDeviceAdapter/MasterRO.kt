 ...
 */
class MasterROMidiDeviceAdapter(
    ...
    companion object {
        ...
        fun assert(
            ...
            if (deviceName?.toLowerCase()?.startsWith("master ro 61") == true || deviceName?.toLowerCase()?.startsWith("pop piano lite") == true) {
                val p = MasterROMidiDeviceAdapter(midiDeviceInfo, inputPort)
