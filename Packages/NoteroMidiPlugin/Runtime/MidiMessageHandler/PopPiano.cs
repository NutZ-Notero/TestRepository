...
{
    public class PopPianoMidiDeviceAdapter : MidiDeviceInfo
    {
        private PopPianoMidiDeviceAdapter(int uniqueId, string deviceName) : base(uniqueId, deviceName)
        {
        ...
        {
            return deviceName.ToLower().StartsWith("pop piano")
                ? new PopPianoMidiDeviceAdapter(uniqueId, deviceName)
                : null;
        }
