...
{
    public class GeneralMidiDeviceAdapter : MidiDeviceInfo
    {
        private GeneralMidiDeviceAdapter(int uniqueId, string deviceName) : base(uniqueId, deviceName)
        {
        ...
        {
            return deviceName.ToLower().StartsWith("general")
                ? new GeneralMidiDeviceAdapter(uniqueId, deviceName)
                : null;
        }
